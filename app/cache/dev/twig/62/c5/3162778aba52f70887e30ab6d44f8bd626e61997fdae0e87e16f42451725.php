...
/* PortfolioBundle:Cv:edit.html.twig */
class __TwigTemplate_62c53162778aba52f70887e30ab6d44f8bd626e61997fdae0e87e16f42451725 extends Twig_Template
{
    ...
    {
        echo "<h1>Protfolio : administration : cv : Edit</h1>";
    }
...
";
    ...
    <div class=\"control-group\">
     ...
     <div class=\"control-group\">
        ...
        // line 26
        echo "        ";
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "file"), 'label', array("label_attr" => array("class" => "control-label"), "label" => "cv"));
        echo "
        <div class=\"controls\">
            ";
        // line 28
        ...
        // line 31
        echo "            ";
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "file"), 'widget', array("attr" => array("class" => "cv")));
        echo "
        </div>
    </div>
    <div class=\"control-group\">
    ...
    <div class=\"control-group\">
        ...
        // line 48
        echo "   
            <input type=\"submit\" name=\"edit\" value=\"Edit\" id=\"edi\" class=\"btn btn-warning\" >
         </div>         
    </div>
</form>
";
    ...
    {
        return "PortfolioBundle:Cv:edit.html.twig";
    }
