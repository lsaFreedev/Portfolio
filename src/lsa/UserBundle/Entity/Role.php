...
class Role  implements RoleInterface
{
     ...
     * Add users
     *
     * @param \lsa\UserBundle\Entity\User $users
     * @return Role
     */
    public function addUser(\lsa\UserBundle\Entity\User $users)
    {
        $this->users[] = $users;
     ...
     * @param \lsa\UserBundle\Entity\User $users
     */
    public function removeUser(\lsa\UserBundle\Entity\User $users)
    {
